    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p>VNĐ<?php echo htmlentities($result->PricePerDay);?> </p>Giờ
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap">
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              ...
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Thành phần</a></li>
            </ul>
      ...
      <aside class="col-md-3">
        ...
        <div class="share_vehicle">
          <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method=POST>
            <input type="password" name="pin" placeholder="Nhập mã pin để kích hoạt">
            <input type="submit" name="" value="Kích hoạt" >
            <?php 
            $pina="111111";
            $PIN= trim($_POST['pin']);
            if($PIN == $pina ) {
              echo "Kích hoạt thành công";
                ...
                echo "Kích hoạt không thành công";
             }
            ?>
          </form>
        </div>
        <div class="sidebar_widget">
          ...
          <form method="post">
            <div class="form-group">
              <input type="text" class="form-control" name="fromdate" placeholder="Từ ngày DD/MM/YYYY" required>
            </div>
            <div class="form-group">
              <input type="text" class="form-control" name="todate" placeholder="Đến ngày DD/MM/YYYY" required>
            </div>
            <div class="form-group">
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">VNĐ<?php echo htmlentities($result->PricePerDay);?></p>

              <ul class="features_list">

             <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->SeatingCapacity);?> Chỗ ngồi</li>
                <li><i class="fa fa-calendar" aria-hidden="true"></i><?php echo htmlentities($result->ModelYear);?> Kiểu xe</li>
